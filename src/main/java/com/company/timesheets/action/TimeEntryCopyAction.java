...
public class TimeEntryCopyAction
        extends SecuredListDataComponentAction<TimeEntryCopyAction, TimeEntry> // Action that changes its enabled property depending on a selected item in a bound Grid.
        implements AdjustWhenViewReadOnly { // Interface to be implemented by actions which may adjust their 'enabled' state according to the view read-only mode.
