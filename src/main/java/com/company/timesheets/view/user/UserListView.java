...
public class UserListView extends StandardListView<User> {
    ...
    private void doSendEmail(String title, String body, Collection<User> users) {
        BackgroundTask<Integer, Void> task = new EmailTask(title, body, users, emailer);
...
//                .withHeader("Sending remainder emails")
...
//                .open();
    ...
    private class EmailTask extends BackgroundTask<Integer, Void>  {
        ...
        protected EmailTask(String title, String body, Collection<User> users, Emailer emailer) {
